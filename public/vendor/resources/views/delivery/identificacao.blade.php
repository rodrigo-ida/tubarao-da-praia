    ...
    <div id="scroll-forms">
        <div id="drop">
            ...
            <div class="login__form clearfix">
                <form action="/delivery/client" method="POST">
                    {{ csrf_field() }}
                    <input class="login__email" name="email" id="emailclient" value="@if(Session::get('email')) {{ Session::get('email') }} @endif" placeholder="E-mail" type="email">
                    <input class="login__enviar" type="submit" value="Pesquisar">
