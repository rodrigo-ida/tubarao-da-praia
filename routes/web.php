...
Route::get('/', function () {
    ...
    } else if ($_SERVER['HTTP_HOST'] == 'pedidos.tubaraodapraia.com.br') {
...
Route::get('/delivery/loja/{slug}', [

    'as' => 'productsdelivery.products',

    'uses' => 'DeliveryController@deliveryProductsByShop'
