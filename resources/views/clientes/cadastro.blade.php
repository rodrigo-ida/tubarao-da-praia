...
@section('content')
    ...
    @if(!empty($_GET['redirect']))
        ...
        {!! Form::hidden('redirect', filter_input(INPUT_GET, 'redirect', FILTER_SANITIZE_FULL_SPECIAL_CHARS)) !!}
    ...
    {!! Form::hidden('origem',$cliente->origem)!!}
    ...
    <div >
        ...
        <div>
            ...
            {!! Form::text('sobrenome', null, ['id' => 'sobrenome', 'placeholder' => 'Seu sobrenome', 'required', 'tabindex' => '1', 'autocomplete' => 'off']) !!}
